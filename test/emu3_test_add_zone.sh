...
TEST_BANK_NAME=$srcdir/emu3_test_add_zone
...
test
logAndRun 'diff $TEST_BANK_NAME data/emu3_test_add_zone_1'
test

logAndRun '$srcdir/../src/emu3bm -s data/s1.wav $TEST_BANK_NAME'
test
logAndRun 'diff $TEST_BANK_NAME data/emu3_test_add_zone_2'
test

logAndRun '$srcdir/../src/emu3bm -e 0 -z 1,pri,F1,C1,B1 $TEST_BANK_NAME'
test
logAndRun 'diff $TEST_BANK_NAME data/emu3_test_add_zone_3'
test

logAndRun '$srcdir/../src/emu3bm -e 0 -z 1,pri,F2,C2,B2 $TEST_BANK_NAME'
test
logAndRun 'diff $TEST_BANK_NAME data/emu3_test_add_zone_4'
test

logAndRun '$srcdir/../src/emu3bm -e 0 -z 1,sec,f1,c1,b1 $TEST_BANK_NAME'
test
logAndRun 'diff $TEST_BANK_NAME data/emu3_test_add_zone_5'
test
